...
// public static void setLimelightNTDoubleArray(String tableName, String
// entryName, double[] val) {
// getLimelightNTTableEntry(tableName, entryName).setDoubleArray(val);
// }

// public static double[] getLimelightNTDoubleArray(String tableName, String
// entryName) {
// return getLimelightNTTableEntry(tableName, entryName).getDoubleArray(new
// double[0]);
// }
...
// String urlString = "http://" + sanitizeName(tableName) + ".local:5807/" +
// request;
// URL url;
// try {
...
// double[] poseArray = getLimelightNTDoubleArray(limelightName,
// "botpose_wpired");
// return toPose3D(poseArray);
// }
...
// public static void setPythonScriptData(String limelightName, double[]
// outgoingPythonData) {
...
// private static boolean SYNCH_TAKESNAPSHOT(String tableName, String
// snapshotName) {
