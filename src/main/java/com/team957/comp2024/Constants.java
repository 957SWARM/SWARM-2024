...
public class Constants {
    ...
    public static final class IntakeRollerConstants {
        ...
        public static final int STALENESS_THRESHOLD_CYCLES = 5; // reports stale data fault if reported value is
                                                                // identical for this many cycles
    }
    ...
    public static final class VisionConstants {
        ...
        public static final Vector<N3> VISION_STDS = VecBuilder.fill(2, 2, Units.degreesToRadians(60));
        ...
        public static final Transform3d LL2_TO_CENTER = new Transform3d(new Translation3d(0, 0, 0),
                new Rotation3d(0, 0, 0));
        public static final Transform3d PCAM_TO_CENTER = new Transform3d(new Translation3d(0, 0, 0),
                new Rotation3d(0, 0, 0));
    ...
    public static final class SparkMaxAlertsConstants {
        ...
        public static final double SUSPICIOUS_TEMPERATURE_RATE = 50; // 50 celsius / second is not going to happen, ever
    }
}
